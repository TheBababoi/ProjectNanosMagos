...
public class Bunny1 extends NPC {
    ...
    public void setDialogue() {
        ...
        dialogues[0][1] = "I was walking around the labyrinth,\n but my mushrooms fell off my basket  \nand now some wild worms appeared";
        dialogues[0][2] = "I dont want my mushrooms \n to be eaten by these filthy worms";

        dialogues[1][0] = "Please save my mushrooms!";
